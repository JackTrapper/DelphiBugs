...
begin
  ...
  begin
    ...
    if (TaskbarHandler <> nil) and not(csDestroying in ComponentState) then
      if Value then
        TaskbarHandler.InitializeButtons
      else
...
begin
  ...
  begin
    ...
    if (Msg.Message <> WM_MENUSELECT) and FMenuBarHook.FEnterWithKeyboard then
